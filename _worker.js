...
// Variables
const rootDomain = "hamil52368.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "urepo"; // Ganti dengan nama workers kalian
const apiKey = "jPsrgeYxtRYD5PQpgQ_S3XjSySlYwQSn7skQ3LcX"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "hamil52368@cavoyar.com"; // Ganti dengan email yang kalian gunakan
const accountID = "73be48d39cfdc88445e500c9f7388017"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
